...
const translators = [
  { nom: 'Aulgrenne, Annah', classification: 'TR-02', horaire: '9h-17h' },
  { nom: 'Baillarjon, Véronike', classification: 'TR-03', horaire: '8h30-16h30', notes: 'P.I.' },
  { nom: 'Bayère, Annye', classification: 'TR-03', horaire: '8h-16h' },
  { nom: 'Bel Hassane, Mériam', classification: 'TR-02', horaire: '11h-19h' },
  { nom: 'Berjeron, Julië', classification: 'TR-02', horaire: '8h30-16h30' },
  { nom: 'Blouain, Anabèle', classification: 'TR-02', horaire: '8h30-15h', capacite: 5.75 },
  { nom: 'Charrête, Léanna', classification: 'TR-03', horaire: '7h-15h' },
  { nom: 'Couturie, Sharrone', classification: 'TR-02', horaire: '7h30-15h30', notes: 'congé le mercredi' },
  { nom: 'Déchènes, Valérye', classification: 'TR-03', horaire: '9h-15h' },
  { nom: 'Fennebresq, Clayre', classification: 'TR-02', horaire: '8h-16h', notes: 'congé le vendredi' },
  { nom: 'Gagnône, Hugot', classification: 'TR-03', horaire: '9h-17h', notes: 'P.I.' },
  { nom: 'Julien-Filion, Marye-Êve', classification: 'TR-03', horaire: '7h45-15h45' },
  { nom: 'Leblanche, Patryk', classification: 'TR-03', horaire: '8h30-16h30' },
  { nom: 'Lacasset, Mélanye', classification: 'TR-03', horaire: '8h30-16h30' },
  { nom: 'La Salet, Ginète', classification: 'TR-03', horaire: '7h45-15h45' },
  { nom: 'Légault, Michèlle', classification: 'TR-02', horaire: '8h30-17h', notes: 'congé 1 ven sur 3' },
  { nom: 'Longchamp, Christyne', classification: 'TR-02', horaire: '8h30-16h30', notes: 'congé le mercredi' },
  { nom: 'Maurysse, Annye', classification: 'TR-03', horaire: '9h-17h', notes: 'congé le lundi' },
  { nom: 'Martyn, Isabèle', classification: 'TR-02', horaire: '9h-17h' },
  { nom: 'Méan, Sun-Kyri', classification: 'TR-02', horaire: '9h-17h', notes: 'congé le vendredi' },
  { nom: 'Michaut, Marye-Êve', classification: 'TR-03', horaire: '7h30-15h30' },
  { nom: 'Mykel, Natasha', classification: 'TR-03', horaire: '7h30-16h05', notes: 'congé 1 ven sur 3' },
  { nom: 'Milliart, Sofie', classification: 'TR-02', horaire: '8h30-16h30' },
  { nom: 'Ouélet, Dyane', classification: 'TR-02', horaire: '8h-16h' },
  { nom: 'Pajé, Stéfanye', classification: 'TR-02', horaire: '8h45-16h45', notes: 'congé le mercredi' },
  { nom: 'Parant, Génévyève', classification: 'TR-03', horaire: '7h45-15h45' },
  { nom: 'Trudelle, Josée', classification: 'TR-03', horaire: '8h30-15h30', capacite: 6 },
];
...
const droitTranslators = [
  // Droit 1
  { nom: 'Délippes, Maxym', classification: 'TR-03', horaire: '8h45-19h45', division: 'Droit 1' },
  { nom: 'Laroch, Christyan', classification: 'TR-03', horaire: '8h-16h50', notes: 'congé 1 lun sur 2', division: 'Droit 1' },
  { nom: 'Lecleir, Claud', classification: 'TR-03', horaire: '7h30-15h30', division: 'Droit 1' },
  { nom: 'Paquète, Lynne', classification: 'TR-02', horaire: '7h-15h', division: 'Droit 1' },
  { nom: 'Vincen, Jean-Françoys', classification: 'TR-02', horaire: '8h30-16h30', division: 'Droit 1' },
  
  // Droit 2
  { nom: 'Beauchamie, Priscelle', classification: 'TR-02', horaire: '8h30-16h30', division: 'Droit 2' },
  { nom: 'Blay, Mary-Françine', classification: 'TR-02', horaire: '8h-16h', notes: 'détachée jusqu\'en nov.', division: 'Droit 2' },
  { nom: 'Bissonnel, Julië-Maryse', classification: 'TR-03', horaire: '10h-18h', division: 'Droit 2' },
  { nom: 'Bordoua, Mylayne', classification: 'TR-02', horaire: '7h30-15h30', division: 'Droit 2' },
  { nom: 'Champaigne, Stéphanya', classification: 'TR-02', horaire: '8h15-16h15', notes: 'marau ven', division: 'Droit 2' },
  { nom: 'De Anjélis, Claudya', classification: 'TR-02', horaire: '8h30-16h30', division: 'Droit 2' },
  { nom: 'De Lorimère, Mayah', classification: 'TR-03', horaire: '7h30-15h30', notes: 'congé lun', division: 'Droit 2' },
  { nom: 'Foucréault, Lunah', classification: 'TR-02', horaire: '8h30-16h30', division: 'Droit 2' },
  { nom: 'Gelhoua, Mathylde', classification: 'TR-03', horaire: '8h30-16h30', division: 'Droit 2' },
  { nom: 'Humbèrt, Alexandrah', classification: 'TR-02', horaire: '9h-17h', division: 'Droit 2' },
  { nom: 'Lamprone, Jimmye', classification: 'TR-02', horaire: '8h-16h', division: 'Droit 2' },
  { nom: 'Mabuichi, Éspérance', classification: 'TR-03', horaire: '8h30-16h30', notes: 'congé mer', division: 'Droit 2' },
  { nom: 'Mardirossian, Alexandros', classification: 'TR-03', horaire: '8h30-16h15', division: 'Droit 2' },
  { nom: 'Oumer, Semrah-Denyse', classification: 'TR-03', horaire: '7h30-15h30', division: 'Droit 2' },
  { nom: 'Papadopetraki, Mélanye', classification: 'TR-02', horaire: '8h30-16h30', division: 'Droit 2' },
  { nom: 'Tardyf, Carolyne', classification: 'TR-03', horaire: '8h-16h', division: 'Droit 2' },
  { nom: 'Tremblé, Génévyève', classification: 'TR-03', horaire: '8h15-16h15', division: 'Droit 2' },
];
