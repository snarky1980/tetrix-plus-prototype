...
import equipeProjetAccessRoutes from './routes/equipeProjetAccessRoutes';
...
import equipeConseillerRoutes from './routes/equipeConseillerRoutes';
...
app.use('/api/equipe-projet-access', equipeProjetAccessRoutes);
...
app.use('/api/equipes-conseiller', equipeConseillerRoutes);
